...
function FeaturesSection() {
  ...
  return (
    ...
    <button className=' my-[60px] m-auto px-12 py-4 rounded-lg text-sm bg-primary hover:bg-primary-dull transition  font-medium cursor-pointer' onClick={()=>{nav('/movies'); scrollTo(0,0)}}>show more</button>
    </div>
    </div>
  )
}
